...
description: Complete API reference for implementing hooks in Claude Code - configuration, hook events, decision control, and security best practices.
---
...
For practical examples including code formatting, notifications, and file protection, see the hooks-guide documentation.
